...
CREATE UNIQUE INDEX WATSON.SCHD_SHIFT_U01
    ON WATSON.SCHD_SHIFT( PLANT_CODE, SHIFT_NAME );
...
CREATE OR REPLACE TRIGGER WATSON.BIU_SCHD_SHIFT
    BEFORE INSERT OR UPDATE
    ON WATSON.SCHD_SHIFT
